...
Перейдя на вкладку _"Дополнительно"_ проверяем, что значение поля _"Безопасность соединения"_ установлено в _"Требовать шифрование"_. Порт соединение остается `5222`. _"Прокси передачи файлов"_ можно изменить на `proxy.riseup.net`. В конце жмем на кнопку _"Добавить"_.
